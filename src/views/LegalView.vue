<template>
  <CardElt class="container-90sm-80md-70lg-60xl-50wd">
    ...
    <template #body>
      <h2>TERMS & CONDITIONS FOR USE, REPRODUCTION & DISTRIBUTION</h2>
      ...
      <ul>
        ...
        <li>
          ...
          <p>
            You may reproduce & distribute copies of the Work or Derivative Works thereof in any medium, with or without modifications, & in Source or Object form, provided that You meet the following conditions:
          </p>
          <ul>
            <li>
            ...
            <li>
              (c) You must retain, in the Source form of any Derivative Works that You distribute, all copyright, patent, trademark, & attribution notices from the Source form of the Work, excluding those notices that do not pertain to any part of the Derivative Works; and
            </li>
            <li>
        ...
        <li>
          ...
          <p>
            Unless You explicitly state otherwise, any Contribution intentionally submitted for inclusion in the Work by You to the Licensor shall be under the terms & conditions of this License, without any additional terms or conditions. Notwithstanding the above, nothing herein shall supersede or modify the terms of any separate license agreement you may have executed with Licensor regarding such Contributions.
          </p>
        </li>
        ...
        <li>
          <h3>6. Trademarks</h3>
          <p>
            This License does not grant permission to use the trade names, trademarks, service marks, or product names of the Licensor, except as required for reasonable & customary use in describing the origin of the Work & reproducing the content of the NOTICE file.
          </p>
        </li>
        ...
        <li>
          ...
          <p>
            Unless required by applicable law or agreed to in writing, Licensor provides the Work (& each Contributor provides its Contributions) on an "AS IS" BASIS, WITHOUT WARRANTIES OR CONDITIONS OF ANY KIND, either express or implied, including, without limitation, any warranties or conditions of TITLE, NON-INFRINGEMENT, MERCHANTABILITY, or FITNESS FOR A PARTICULAR PURPOSE. You are solely responsible for determining the appropriateness of using or redistributing the Work & assume any risks associated with Your exercise of permissions under this License.
          </p>
        </li>
        ...
        <li>
          ...
          <p>
            In no event & under no legal theory, whether in tort (including negligence), contract, or otherwise, unless required by applicable law (such as deliberate & grossly negligent acts) or agreed to in writing, shall any Contributor be liable to You for damages, including any direct, indirect, special, incidental, or consequential damages of any character arising as a result of this License or out of the use or inability to use the Work (including but not limited to damages for loss of goodwill, work stoppage, computer failure or malfunction, or any & all other commercial damages or losses), even if such Contributor has been advised of the possibility of such damages.
          </p>
        </li>
        ...
        <li>
          ...
          <p>
            While redistributing the Work or Derivative Works thereof, You may choose to offer, & charge a fee for, acceptance of support, warranty, indemnity, or other liability obligations &/or rights consistent with this License. However, in accepting such obligations, You may act only on Your own behalf & on Your sole responsibility, not on behalf of any other Contributor, & only if You agree to indemnify, defend, & hold each Contributor harmless for any liability incurred by, or claims asserted against, such Contributor by reason of your accepting any such warranty or additional liability.
          </p>
        </li>
      </ul>

      <b>Copyright 2023 Philippe Beck</b>
