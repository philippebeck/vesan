...
export default {
  ...
  CATS_ARTICLE: ['Culture', 'Fashion', 'Health', 'Science', 'Sport', 'Technology', 'Travel'],

  CATS_LINK: ['Culture', 'Fashion', 'Health', 'Science', 'Sport', 'Technology', 'Travel'],

  CATS_ORDER: ['Pending', 'Paid', 'Done', 'Canceled'],

  CATS_PRODUCT: ['Culture', 'Fashion', 'Health', 'Science', 'Sport', 'Technology', 'Travel'],

  CATS_PROJECT: ['Packages', 'Websites'],
  ...
  ARTICLE_FORM: ['name', 'text', 'image', 'alt', 'cat'],

  CONTACT_FORM: ['email', 'subject', 'text'],

  GALLERY_FORM: ['name', 'author'],

  IMAGE_FORM: ['image', 'description'],

  LINK_FORM: ['name', 'url', 'cat'],

  PRODUCT_FORM: ['name', 'description', 'image', 'alt', 'price', 'options', 'cat'],

  PROJECT_FORM: ['name', 'description', 'image', 'alt', 'url', 'cat'],

  USER_FORM: ['name', 'email', 'image', 'pass'],
